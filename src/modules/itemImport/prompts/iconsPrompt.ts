...
## Задача:
1. Для КАЖДОГО предмета добавь или замени поле "img" на подходящую иконку из списка выше
...
3. Сохрани ВСЕ остальные поля и данные каждого объекта без изменений

## ВАЖНО - Формат ответа:
- Верни ПОЛНЫЙ JSON массив со ВСЕМИ объектами и ВСЕМИ их полями
- Меняй ТОЛЬКО поле "img" — остальное копируй как есть
- Не сокращай, не пропускай поля, не возвращай только img
